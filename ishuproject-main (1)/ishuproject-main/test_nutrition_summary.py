...
with app.app_context():
    ...
    # Create meal planner with database and recommender
    ...
    print("=" * 60)
    print(f"\nMeal Plan for {meal_plan['total_days']} days")
    ...
    for i, day_data in enumerate(meal_plan['days'], 1):
        daily_nutrition = day_data.get('daily_nutrition', {})
        print(f"\n  Day {i}:")
        print(f"    - Calories: {daily_nutrition.get('calories', 'N/A')}")
        print(f"    - Protein: {daily_nutrition.get('protein', 'N/A')}")
        print(f"    - Iron: {daily_nutrition.get('iron', 'N/A')}")
        print(f"    - Calcium: {daily_nutrition.get('calcium', 'N/A')}")
        print(f"    - Fiber: {daily_nutrition.get('fiber', 'N/A')}")
        print(f"    - Folic Acid: {daily_nutrition.get('folic_acid', 'N/A')}")
